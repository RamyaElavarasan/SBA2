...
public class AdminController {
	...
	public ResponseEntity<List<UserDto>> getAllClerks(String role){
		return new ResponseEntity<>(adminService.getAllClerks(role),HttpStatus.OK);
	}
	
	@GetMapping("/all-managers")
	public ResponseEntity<List<UserDto>> getAllManagers(String role){
		return new ResponseEntity<>(adminService.getAllManagers(role),HttpStatus.OK);
	}
